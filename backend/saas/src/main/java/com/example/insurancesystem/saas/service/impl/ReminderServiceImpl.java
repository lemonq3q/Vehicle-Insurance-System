...
/**
 * 根据订阅、余额与工单快照生成七类企业风险提醒，并实现阶段合并。
...
public class ReminderServiceImpl implements ReminderService {
    ...
    private void generateExpiryReminders(Map<String, Object> source, LocalDateTime now) {
        ...
        if (bool(source, "autoRenewEnabled")) {
            ...
            emit(source, "AUTO_RENEW_BALANCE_INSUFFICIENT",
            ...
            emit(source, "SUBSCRIPTION_EXPIRING_NO_AUTO_RENEW",
    ...
    private void generateQuotaReminders(Map<String, Object> source, LocalDateTime now) {
        ...
        if (used >= limit) {
            ...
            emit(source, "WORKORDER_QUOTA_REACHED",
        ...
        emit(source, "WORKORDER_QUOTA_NEAR_LIMIT",
    ...
    private void generateBalanceReminders(Map<String, Object> source, LocalDateTime now) {
        ...
        emit(source, "WALLET_BALANCE_NEGATIVE", "WALLET_BALANCE_NEGATIVE" + baseKey,
        ...
        if (balance.compareTo(near) <= 0 && balance.compareTo(suspend) >= 0) {
            emit(source, "WALLET_BALANCE_NEAR_SUSPENSION", "WALLET_BALANCE_NEAR_SUSPENSION" + baseKey,
        ...
        if (integer(source, "subscriptionStatus") == 3 && "ARREARS".equals(string(source, "suspendReason"))) {
            ...
            emit(source, "SUBSCRIPTION_SUSPENDED_ARREARS",
    ...
    private void generateDataDeletionReminder(Map<String, Object> source, LocalDateTime now) {
        ...
        emit(source, "ENTERPRISE_DATA_DELETION_APPROACHING",
     ...
     */
    private void emit(Map<String, Object> source, String type, String key, Stage stage, String severity,
        ...
        reminder.put("reminderType", type);
